...
class MakeStar : MapHook {
	...
	Argument rad("Radius", AT_Range, "3000.0", doc="Raidus of the star");
...
class MakePlanet : MapHook {
	...
	Argument radius(AT_Range, "100:200", doc="Size of the planet, can be a random range.");
	Argument orbit_spacing(AT_Range, "1250:2750", doc="Distance from the previous planet.");
