...
const double HYPERDRIVE_COST = 0.03;
...
const double FLING_BEACON_RANGE = 150000.0;
const double FLING_BEACON_RANGE_SQ = sqr(FLING_BEACON_RANGE);
const double FLING_COST = 8.0;
const double FLING_CHARGE_TIME = 30.0;
const double FLING_TIME = 30.0;
...
const double JUMPDRIVE_COST = 0.02;
const double JUMPDRIVE_START_COST = 30.0;
